...
# Generate guide for load completion scripts for
...
set E:ARGC_COMPLETIONS_DIR = '__COMPLETIONS_DIR__'
...
let-env ARGC_COMPLETIONS_DIR = "__COMPLETIONS_DIR__"
...
EOF
    ...
    *)
    ...
    echo "$content" | sed \
        ...
        -e 's|__COMPLETIONS_DIR__|'"$completions_dir"'|g' \
