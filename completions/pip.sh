...
# @option --keyring-provider <keyring_provider>    Enable the credential lookup via the keyring library if user input is allowed.
...
# @option --all[setuptools|pip|distribute|wheel]   Do not skip these packages in the output: setuptools, pip, distribute, wheel
