...
# @flag --with-working-dir         Create a working directory (normal repository) [DEFAULT]
# @flag --no-working-dir           Do not create a working directory (bare repository)
# @option --repodir <DIRECTORY>    specify the repository directory in which to run
# @flag --help                     show a brief description of the command and its options
# @flag --list-options             show plain list of available options and commands, for auto-completion
# @flag --disable                  disable this command
# @flag --debug                    give only debug output
...
# @flag --human-readable           give human-readable output [DEFAULT]
# @flag --machine-readable         give machine-readable output
...
# @flag --leave-test-directory         don't remove the test directory [DEFAULT]
# @flag --remove-test-directory        remove the test directory
# @flag -a --all
# @flag --no-interactive               answer yes to all patches
# @flag -i --interactive               prompt user interactively
...
# @flag --reorder-patches                 reorder the patches in the repository
# @flag --no-reorder-patches              don't reorder the patches in the repository [DEFAULT]
# @flag -a --all
# @flag --no-interactive                  answer yes to all patches
# @flag -i --interactive                  prompt user interactively
...
# @flag --no-set-scripts-executable       don't make scripts executable [DEFAULT]
# @option --umask                         specify umask to use when writing
# @flag --restrict-paths                  don't allow darcs to touch external files or repo metadata [DEFAULT]
# @flag --dont-restrict-paths
# @flag --no-restrict-paths               allow darcs to modify any file or directory (unsafe)
...
# @flag --context                     give output suitable for clone --context
# @flag --xml-output                  generate XML formatted output
# @flag --human-readable              give human-readable output
# @flag --machine-readable            give machine-readable output
...
# @flag -v --verbose                      give verbose output
# @flag --timings                         provide debugging timings information
# @option --reply <FROM>                  reply to email-based patch using FROM address
# @option --cc <EMAIL>                    mail results to additional EMAIL(s).
# @flag --happy-forwarding                forward unsigned messages without extra header
# @flag --no-happy-forwarding             don't forward unsigned messages without extra header [DEFAULT]
