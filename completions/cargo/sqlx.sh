...
# @option -D --database-url <DATABASE_URL>       Location of the DB, by default will be read from the DATABASE_URL env var
...
# @flag -s --sequential    If set, use timestamp versioning for the new migration.
# @flag -h --help          Print help (see a summary with '-h')
# @arg description!
migrate::add() {
    :;
