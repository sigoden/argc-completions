...
# @option -t --target[es3|es5|es6/es2015|es2016|es2017|es2018|es2019|es2020|es2021|es2022|esnext]  Set the JavaScript language version for emitted JavaScript and include compatible library declarations.
# @option -m --module[none|commonjs|amd|umd|system|es6/es2015|es2020|es2022|esnext|node16|nodenext]  Specify what module code is generated.
