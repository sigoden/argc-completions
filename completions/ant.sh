...
# @flag --help                       print this message and ant help
# @flag --h                          print this message and ant help
# @flag --noconfig                   suppress sourcing of /etc/ant.conf, $HOME/.ant/ant.conf, and $HOME/.antrc configuration files
# @flag --usejikes                   enable use of jikes by default, unless set explicitly in configuration files
# @flag --execdebug                  print ant exec line generated by this launch script
