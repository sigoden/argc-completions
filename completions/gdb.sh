...
# @flag --init-command                 Like -x but execute commands before loading inferior.
# @flag -ix                            Like -x but execute commands before loading inferior.
# @flag --eval-command                 Execute a single GDB command.
# @flag -ex                            Execute a single GDB command.
# @flag --init-eval-command            Like -ex but before loading inferior.
# @flag -iex                           Like -ex but before loading inferior.
