...
# @option --initial-sequence <INITIAL_SEQUENCE>    The initial sequence number [default: 33434]
...
# @option --dns-ttl <DNS_TTL>                      The time-to-live (TTL) of DNS entries [default: 300s]
# @flag -z --dns-lookup-as-info                    Lookup autonomous system (AS) information during DNS queries [default: false]
# @option -s --max-samples <MAX_SAMPLES>           The maximum number of samples to record per hop [default: 256]
# @option --max-flows <MAX_FLOWS>                  The maximum number of flows to record [default: 64]
...
# @flag --generate-man                             Generate ROFF man page
