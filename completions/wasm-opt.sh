...
# @flag --experimental-new-eh                    Deprecated; same as --emit-exnref
# @flag --emit-exnref                            After running all requested transformations / optimizations, translate the instruction to use the new EH instructions at the end.
