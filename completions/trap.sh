...
# @flag -l    print a list of signal names and their corresponding numbers
# @flag -p    display the trap commands associated with each SIGNAL_SPEC
# @arg signal[`_module_os_signal`]
