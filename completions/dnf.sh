...
# @flag --version                              show DNF version and exit
...
# @flag --obsoletes                            enables dnf's obsoletes processing logic for upgrade or display capabilities that the package obsoletes for info, list and repoquery
...
# @flag --unneeded                             Display only packages that can be removed by "dnf autoremove" command.
...
# @flag --skip-unavailable                     For the replay command, skip packages that are not available or have missing dependencies 'last-<number>' for one transaction, <transaction-id>..<transaction-id> for a range)
...
# @flag --upgrades                             show only upgrades packages
# @flag --autoremove                           show only autoremove packages
# @flag --recent                               show only recently changed packages upgrade, reinstall, move-to, install
# @arg repoid
...
# {{ dnf shell
# @cmd run an interactive DNF shell
# @option -c --config <config file>            config file location
# @flag -q --quiet                             quiet operation
# @flag -v --verbose                           verbose operation
# @flag --version                              show DNF version and exit
...
# {{ dnf swap
# @cmd run an interactive DNF mod for remove and install one spec
# @option -c --config <config file>            config file location
# @flag -q --quiet                             quiet operation
# @flag -v --verbose                           verbose operation
# @flag --version                              show DNF version and exit
