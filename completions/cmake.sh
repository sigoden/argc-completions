...
# @option --version <f>                            Print version number and exit.
# @option -version <f>                             Print version number and exit.
# @option --help-full <f>                          Print all help manuals and exit.
# @option --help-manual[`_choice_help_manual`] <man> <f>  Print one help manual and exit.
# @option --help-manual-list <f>                   List help manuals available and exit.
# @option --help-command[`_choice_help_command`] <cmd> <f>  Print help for one command and exit.
# @option --help-command-list <f>                  List commands with help available and exit.
# @option --help-commands <f>                      Print cmake-commands manual and exit.
# @option --help-module[`_choice_help_module`] <mod> <f>  Print help for one module and exit.
# @option --help-module-list <f>                   List modules with help available and exit.
# @option --help-modules <f>                       Print cmake-modules manual and exit.
# @option --help-policy[`_choice_help_policy`] <cmp> <f>  Print help for one policy and exit.
# @option --help-policy-list <f>                   List policies with help available and exit.
# @option --help-policies <f>                      Print cmake-policies manual and exit.
# @option --help-property[`_choice_help_property`] <prop> <f>  Print help for one property and exit.
# @option --help-property-list <f>                 List properties with help available and exit.
# @option --help-properties <f>                    Print cmake-properties manual and exit.
# @option --help-variable[`_choice_help_variable`] <var> <f>  Print help for one variable and exit.
# @option --help-variable-list <f>                 List variables with help available and exit.
# @option --help-variables <f>                     Print cmake-variables manual and exit.
