...
# @option -t --radix[`_choice_radix`] <{o,d,x}>    Print the location of the string in base 8, 10 or 16
...
# @option -e --encoding[`_choice_encoding`] <{s,S,b,l,B,L}>  Select character size and endianness: s = 7-bit, S = 8-bit, {b,l} = 16-bit, {B,L} = 32-bit
