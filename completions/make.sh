...
# @flag -C                            DIRECTORY, --directory=DIRECTORY Change to DIRECTORY before doing anything.
...
# @flag -E                            STRING, --eval=STRING    Evaluate STRING as a makefile statement.
# @flag -f                            FILE, --file=FILE, --makefile=FILE Read FILE as a makefile.
# @flag -h --help                     Print this message and exit.
# @flag -i --ignore-errors            Ignore errors from recipes.
# @flag -I                            DIRECTORY, --include-dir=DIRECTORY Search DIRECTORY for included makefiles.
...
# @flag -o                            FILE, --old-file=FILE, --assume-old=FILE Consider FILE to be very old and don't remake it.
...
# @flag -W                            FILE, --what-if=FILE, --new-file=FILE, --assume-new=FILE Consider FILE to be infinitely new.
