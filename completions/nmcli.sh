...
_choice_field() {
    printf "%\n" ACTIVE CONNECTION RATE TIMESTAMP ACTIVE-PATH CONNECTIVITY READONLY TIMESTAMP-REAL all CON-PATH RUNNING TYPE AUTOCONNECT CON-UUID SECURITY UUID AUTOCONNECT-PRIORITY DBUS-PATH SIGNAL VERSION BARS DEVICE SLAVE WIFI BSSID MODE SSID WIFI-HW CHAN NAME STARTUP WWAN common NETWORKING STATE WWAN-HW
}
