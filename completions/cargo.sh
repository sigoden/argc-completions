...
# @option --target                             Add as dependency to the given target platform
...
# @option --target                             Remove as dependency from the given target platform
...
# @flag --include-hidden                       Also include hidden paths
# @flag --lib                                  Test only this package's library unit tests
# @option --bin <bin>                          Test only the specified binary
# @flag --bins                                 Test all binaries
# @option --example <example>                  Test only the specified example
# @flag --examples                             Test all examples
# @option --test <test>                        Test only the specified test target
# @flag --tests                                Test all tests
# @option -p --package <package>               Package to run tests for
...
# @flag --all-features                         Activate all available features
# @flag --no-default-features                  Do not activate the `default` feature
# @option --target <target>                    Build for the target triple
