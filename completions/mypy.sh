...
# @option --enable-incomplete-feature[NewGenericSyntax|PreciseTupleTypes]  Enable support of incomplete/experimental features for early preview
# @flag -h --help                              Show this help message and exit
# @flag -v --verbose                           More verbose messages
# @flag -V --version                           Show program's version number and exit
# @option -O --output <FORMAT>                 Set a custom output format
...
# @option --junit-format[global|per_file]      If --junit-xml is set, specifies format.
