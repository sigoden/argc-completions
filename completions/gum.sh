...
# @option --timeout <0>                    Timeout for confirmation ($GUM_CONFIRM_TIMEOUT)
...
# @flag -h --help                  Show context-sensitive help.
# @flag -v --version               Print the version number
# @option --theme <pink>           Glamour theme to use for markdown formatting
# @option -l --language <value>    Programming language to parse code
# @option -t --type[markdown|template|code|emoji] <markdown>  Format to use
...
# @option --width <40>                       Input width ($GUM_INPUT_WIDTH)
...
# @flag -h --help                       Show context-sensitive help.
# @flag -v --version                    Print the version number
# @flag --show-output                   Show output of command ($GUM_SPIN_SHOW_OUTPUT)
...
# @flag -h --help                                Show context-sensitive help.
# @flag -v --version                             Print the version number
# @option --width <50>                           Text area width ($GUM_WRITE_WIDTH)
