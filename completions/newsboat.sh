...
# @flag -e --export-to-opml               export OPML feed to stdout --export-to-opml2  export OPML 2.0 feed including tags to stdout
# @flag -r --refresh-on-start             refresh feeds on start
# @option -i --import-from-opml <file>    import OPML file
# @option -u --url-file <file>            read RSS feed URLs from <file>
# @option -c --cache-file <file>          use <file> as cache file
# @option -C --config-file <file>         read configuration from <file>
...
# @option -d --log-file <file>            use <file> as output log file
...
# @flag -h --help                         this help --cleanup  remove unreferenced items from cache
