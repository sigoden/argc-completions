...
# @option --audio-file-auto-exts-add <value>
# @option --audio-file-auto-exts-append <value>
# @option --audio-file-auto-exts-clr <value>
# @option --audio-file-auto-exts-pre <value>
# @option --audio-file-auto-exts-set <value>
# @option --audio-file-auto-exts-toggle <value>
# @option --audio-file-auto-exts-remove <value>
...
# @option --cache-pause-wait <value>               Float (0 to any) (default: 1)
...
# @option --cover-art-auto-exts-add <value>
# @option --cover-art-auto-exts-append <value>
# @option --cover-art-auto-exts-clr <value>
# @option --cover-art-auto-exts-pre <value>
# @option --cover-art-auto-exts-set <value>
# @option --cover-art-auto-exts-toggle <value>
# @option --cover-art-auto-exts-remove <value>
...
# @option --cscale <value>                         String (default: )
...
# @option --dscale <value>                         String (default: hermite)
...
# @option --image-display-duration <value>         Double (0 to inf) (default: 1)
...
# @option --osd-bar-border-size <value>            Float (0 to 1000) (default: 0.5)
...
# @option --osd-border-size <value>                Float (default: 3)
...
# @option --osd-font-size <value>                  Float (1 to 9000) (default: 55)
...
# @option --scale <value>                          String (default: lanczos)
...
# @option --secondary-sub-ass-override <value>     Choices: no yes force scale strip (default: strip)
...
# @option --sub-ass-line-spacing <value>           Float (-1000 to 1000) (default: 0)
...
# @option --sub-border-size <value>                Float (default: 3)
...
# @option --sub-font-size <value>                  Float (1 to 9000) (default: 55)
...
# @option --tscale <value>                         String (default: oversample)
...
# @option --video-aspect-override <value>          Aspect (-1 to 10) (default: -1)
