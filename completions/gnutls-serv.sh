...
# @option --alpn <str>                   Specify ALPN protocol to be enabled by the server - may appear multiple times
...
# @option --maxearlydata <num>           The maximum early data size to accept
...
# @option --x509keyfile <str>            X.509 key file or PKCS ♯11 URL to use - may appear multiple times
# @option --x509certfile <str>           X.509 Certificate file or PKCS ♯11 URL to use - may appear multiple times
# @option --rawpkkeyfile <str>           Private key file (PKCS ♯8 or PKCS ♯12) or PKCS ♯11 URL to use - may appear multiple times
# @option --rawpkfile <str>              Raw public-key file to use - requires the option 'rawpkkeyfile' - may appear multiple times
...
# @option --ocsp-response <str>          The OCSP response to send to client - may appear multiple times
