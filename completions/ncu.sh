...
# @option --dep[prod|dev|optional|packageManager] <value>  Check one or more sections of dependencies only: dev, optional, peer, prod, or packageManager (comma-delimited).
