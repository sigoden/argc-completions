...
# {{ nix-channel --add
# @cmd Add a channel name located at url to the list of subscribed channels.
...
# {{ nix-channel --remove
# @cmd Remove the channel name from the list of subscribed channels.
# @flag --help                                   Prints out a summary of the command syntax and exits.
# @flag --version                                Prints out the Nix version number on standard output and exits.
# @option -v --verbose[`_module_nix_verbose`]    Increases the level of verbosity of diagnostic messages printed on standard error.
# @flag --quiet                                  Decreases the level of verbosity of diagnostic messages printed on standard error.
...
# {{ nix-channel --list
# @cmd Print the names and URLs of all subscribed channels on standard output.
# @flag --help                                   Prints out a summary of the command syntax and exits.
# @flag --version                                Prints out the Nix version number on standard output and exits.
# @option -v --verbose[`_module_nix_verbose`]    Increases the level of verbosity of diagnostic messages printed on standard error.
# @flag --quiet                                  Decreases the level of verbosity of diagnostic messages printed on standard error.
...
# {{ nix-channel --update
# @cmd Download the Nix expressions of subscribed channels and create a new generation.
# @flag --help                                   Prints out a summary of the command syntax and exits.
# @flag --version                                Prints out the Nix version number on standard output and exits.
# @option -v --verbose[`_module_nix_verbose`]    Increases the level of verbosity of diagnostic messages printed on standard error.
# @flag --quiet                                  Decreases the level of verbosity of diagnostic messages printed on standard error.
...
# @cmd Prints a list of all the current existing generations for the channel profile.
# @flag --help                                   Prints out a summary of the command syntax and exits.
# @flag --version                                Prints out the Nix version number on standard output and exits.
# @option -v --verbose[`_module_nix_verbose`]    Increases the level of verbosity of diagnostic messages printed on standard error.
# @flag --quiet                                  Decreases the level of verbosity of diagnostic messages printed on standard error.
...
# @cmd Revert channels to the state before the last call to nix-channel --update.
# @flag --help                                   Prints out a summary of the command syntax and exits.
# @flag --version                                Prints out the Nix version number on standard output and exits.
# @option -v --verbose[`_module_nix_verbose`]    Increases the level of verbosity of diagnostic messages printed on standard error.
# @flag --quiet                                  Decreases the level of verbosity of diagnostic messages printed on standard error.
