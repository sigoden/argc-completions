...
# @flag -d --delete-old                          Delete all old generations of profiles.
# @option --delete-older-than <period>           Delete all generations of profiles older than the specified amount (except for the generations that were active at that point in time).
