...
# @flag -f                   Force the decryption to proceed even if it is anticipated to require an excessive amount of memory or CPU time.
...
# @flag -P                   Always read passphrase from stdin, and do so only once even when encrypting.
