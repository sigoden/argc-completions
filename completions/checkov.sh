...
# @flag --skip-download                            Do not download any data from Bridgecrew.
# @flag --use-enforcement-rules                    Use the Enforcement rules configured in the platform for hard / soft fail logic.
# @flag --no-guide                                 Deprecated - use --skip-download
# @flag --skip-suppressions                        Deprecated - use --skip-download
